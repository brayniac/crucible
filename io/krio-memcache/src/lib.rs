//! krio-native Memcache client for use inside the krio async runtime.
//!
//! This client wraps a [`krio::ConnCtx`] and provides typed Memcache command
...
//! ```no_run
//! use krio::ConnCtx;
//! use krio_memcache::Client;
//!
//! async fn example(conn: ConnCtx) -> Result<(), krio_memcache::Error> {
...
/// Errors returned by the krio Memcache client.
...
/// A krio-native Memcache client wrapping a single connection.
///
