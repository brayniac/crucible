//! krio-quic — QUIC protocol support for krio via quinn-proto.
//!
//! This crate wraps [quinn-proto](https://docs.rs/quinn-proto)'s sans-IO QUIC
//! state machine and exposes an event-based [`QuicEndpoint`] API that
//! integrates with krio's [`EventHandler`](krio::EventHandler) callbacks.
//!
//! # Example
//!
//! ```rust,ignore
