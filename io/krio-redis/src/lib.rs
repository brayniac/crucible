//! krio-native RESP client for use inside the krio async runtime.
//!
//! This client wraps a [`krio::ConnCtx`] and provides typed Redis command
...
/// Errors returned by the krio RESP client.
...
/// A krio-native RESP client wrapping a single connection.
///
