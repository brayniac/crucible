...
function(
    ...
    {
        name: 'flamegraph_client_' + cache_backend + '_' + runtime + '_t' + benchmark_threads,
        jobs: {
            server: {
            ...
            client: {
                ...
                steps: [
                    ...
                    // Start load generation in background for profiling
                    systemslab.bash(
                        |||
                            export HOME=/tmp/crucible-build
                    ...
                    systemslab.upload_artifact('flamegraph.svg', tags=['flamegraph', 'client', io_engine]),
