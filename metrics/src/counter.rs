...
/// static GETS: Counter = Counter::new(&GROUP, slots::GETS);
/// static SETS: Counter = Counter::new(&GROUP, slots::SETS);
///
/// GETS.increment();
/// SETS.add(5);
/// ```
...
/// static GROUP: CounterGroup = CounterGroup::new();
///
/// #[metric(name = "my_counter", description = "Example counter")]
/// static MY_COUNTER: Counter = Counter::new(&GROUP, 0);
///
/// MY_COUNTER.increment();
/// assert!(MY_COUNTER.value() >= 1);
/// ```
pub struct Counter {
